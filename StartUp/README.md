 ...
 * Written by Willwms Rolé-Dubruille <jeanwillems@hotmail.fr>.
 */
```
...
- [SQL >=8.2.12](https://www.mysql.com/fr/downloads/)
...
![Symfony view](./studi-startup-view.png "Symfony configuration view")
...
[⬆️ Back to top](#studi-startup-symfony-lts-api)
