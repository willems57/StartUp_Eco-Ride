...
export const allRoutes = [
    ...
    new Route("/administrateur", "administrateur", "/admin/administrateur.html", ["ROLE_ADMIN"], "/admin/administrateur.js"),
    ...
    new Route("/signup2", "signupA", "/admin/signup2.html", ["ROLE_ADMIN"], "/admin/signup2.js"),
    new Route("/suspendu", "suspendu", "/admin/suspendu.html", ["ROLE_ADMIN"], "/admin/suspendu.js"),
    new Route("/utilisateurs", "utilisateurs", "/pages/utilisateurs/utilisateurs.html", ["ROLE_USER"], "/pages/utilisateurs/utilisateurs.js"),
    new Route("/abonees", "abonees", "/admin/abonees.html", ["ROLE_ADMIN"], "/admin/abonees.js"),
