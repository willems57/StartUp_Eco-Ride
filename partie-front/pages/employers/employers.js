...
function supprimerAvis(avisId) {
    ...
    fetch(`https://api.Startup_Eco-Ride.platform.sh/api/avisvalidation/${avisId}`, requestOptions)
        .then((response) => {
            if (response.ok) {
...
function getInfosMessages() {
    ...
    fetch("https://api.Startup_Eco-Ride.platform.sh/api/contacts", requestOptions)
        .then(response => {
            if (response.ok) {
                return response.json();
            } else {
